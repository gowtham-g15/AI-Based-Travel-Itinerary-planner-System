...
import { PaperAirplaneIcon, EyeIcon, EyeSlashIcon, Bars3Icon, XMarkIcon, SparklesIcon, StarIcon, HeartIcon } from '@heroicons/react/24/outline';
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100">
            <div className="px-4 py-4 space-y-3">
              <Link to="/login" className="block text-amber-600 font-medium py-2">
                Login
              </Link>
              <Link to="/signup" className="block text-gray-600 hover:text-gray-900 font-medium py-2">
                Sign Up
              </Link>
            </div>
          </div>
